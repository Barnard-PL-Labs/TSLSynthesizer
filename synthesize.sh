...
#TODO: This prints to command line to send synthesize javascript code somewhere
#This is bad design - we should fix it 
#suggestion server.js should read a temp file 
